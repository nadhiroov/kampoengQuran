<html lang="en" class="wf-lato-n3-active wf-lato-n4-active wf-lato-n7-active wf-lato-n9-active wf-flaticon-n4-active wf-fontawesome5solid-n4-active wf-fontawesome5regular-n4-active wf-fontawesome5brands-n4-active wf-simplelineicons-n4-active wf-active">
            ...
            <div class="container container-login animated fadeIn" style="display: block;">
                ...
                <div class="login-form">
                    ...
                    <?php if (session()->getFlashdata()): ?>
                        <label id="name-error" class="error"><?= session()->getFlashdata('msg_pass') ?></label>
                    <?php endif; ?>
